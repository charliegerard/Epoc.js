...
$(builddir)/index.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/index.node: TOOLSET := $(TOOLSET)
$(builddir)/index.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/index.node
# Add target alias
.PHONY: index
index: $(builddir)/index.node

# Short alias for building this executable.
.PHONY: index.node
index.node: $(builddir)/index.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/index.node
