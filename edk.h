...
extern "C"
{
	...
	typedef enum EE_MotionDataChannels_enum {
		ED_COUNTER = 0, ED_INTERPOLATED,
		ED_GYROX, ED_GYROY, ED_GYROZ, ED_ACCX, ED_ACCY,
		ED_ACCZ, ED_MAGX, ED_MAGY, ED_MAGZ,
		ED_MARKER
    ...
    */
    ...
    /*!
        ...
        \return EDK_ERROR_CODE
                - EDK_ERROR_CODE = EDK_OK if successful
    */
    EDK_API int EE_MotionDataGet(DataHandle hData, EE_MotionDataChannel_t channel, double buffer[],
